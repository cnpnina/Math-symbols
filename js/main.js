...
(async function(){  
    ...
    model = await tf.loadLayersModel("https://raw.githubusercontent.com/cnpnina/Math-symbols/main/models/model.json")
...
function displayLabel(data) { 
    ...
    let math_symbol = ['Divide', 'Equal', 'Intigrate', 'Lambda', 'Minus', 'Mu', 'Plus', 'Root', 'Sigma (uppercase)', 'Sigma (lowercase)', 'Times']
document.getElementById('result').innerHTML = math_symbol[maxIndex];  
